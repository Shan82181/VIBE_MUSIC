        ...
        <div className="flex flex-col items-center w-1/3">
          <div className="flex items-center gap-4 mb-2">
            ...
            <button
              ...
              title={
                loop === "none" ? "Enable loop" : 
                loop === "one" ? "Loop one track" : "Loop all tracks"
              }
            >
              {loop === "one" ? (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4z"/>
                  <text x="8" y="19" fontSize="8" fill="currentColor">1</text>
                </svg>
              ) : (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4z"/>
        ...
        <div className="w-1/3 flex justify-end gap-3 text-gray-400">
          ...
          <div className="relative group flex items-center">
            ...
            >
              {volume === 0 ? (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M3.63 3.63a.996.996 0 000 1.41L7.29 9H6c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2h1.29l3.66 3.66c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L5.05 5.05a.996.996 0 00-1.41 0l-3.66 3.66c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0L3.63 3.63zm12.5 12.5l-1.41-1.41 3.13-3.13-3.13-3.13 1.41-1.41L20.5 12l-4.37 4.13z"/>
                </svg>
              ) : volume < 0.5 ? (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className={`p-2 transition-colors rounded-full hover:bg-white/10 ${
              queue.length > 0 ? "text-gray-400 hover:text-white" : "text-gray-600 cursor-not-allowed"
            }`}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-neutral-800 text-white border-neutral-700 w-48">
              ...
              <DropdownMenuItem 
                onClick={() => {
                  toast.info(`Queue: ${queueInfo.positionInQueue} of ${queueInfo.queueLength} tracks`);
                }}
                className="cursor-pointer focus:bg-neutral-700"
              >
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
